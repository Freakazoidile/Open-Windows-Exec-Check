...
class RemoteShell(cmd.Cmd):
    def __init__(self, share, win32Process, smbConnection):
        ...
        # We don't wanna deal with timeouts from now on. - Changed timeout to 25 seconds.
        if self.__transferClient is not None:
            self.__transferClient.setTimeout(25000)
            self.do_cd('\\')
        else:
    ...
    def get_output(self):
        ...
        while True:
            try:
                ...
                elif str(e).find('STATUS_BAD_NETWORK_NAME') >= 0: # If share is wrong, catch.
                    break
